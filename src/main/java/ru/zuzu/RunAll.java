...
public class RunAll {
    ...
    public static void main(String[] args) throws Exception {
        ...
        jobPreprocessing.setMapOutputKeyClass(TextPair.class);
        jobPreprocessing.setMapOutputValueClass(TextPair.class);
        jobPreprocessing.setOutputKeyClass(TextPair.class);
